    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <Card className="p-8 md:p-16 border-2 bg-gradient-to-br from-card via-background to-secondary text-center">
            ...
            <div className="pt-8 border-t border-border">
              <p className="text-muted-foreground mb-4 font-medium">Partnering Organizations</p>
              <div className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
                <span>Sports Scotland</span>
                <span className="text-border">•</span>
                <span>LEAP Sports</span>
                <span className="text-border">•</span>
                <span>PRIDE Sports</span>
                <span className="text-border">•</span>
                <span>UWS</span>
              </div>
            </div>
